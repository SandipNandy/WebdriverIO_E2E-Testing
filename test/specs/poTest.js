...
//webdriverio Async  (Sync)
   ...
   await browser.waitUntil(async()=>await loginPage.signIn.getAttribute('value') === 'Sign In',
    ...
    await console.log(await loginPage.alert.getText())
    await expect(await loginPage.textInfo).toHaveTextContaining("username is SNacademy and Password is learningNOW")
...

{
   ...
   await browser.url("/loginpagePractise/#")
    await loginPage.Login("SNacademy","learningNOW")
